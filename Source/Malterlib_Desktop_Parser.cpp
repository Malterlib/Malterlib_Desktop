...
namespace NMib
{
	namespace NDesktopIntegration
	{
		...
		void CDesktopFileParser::f_Write()
		{
			...
			NContainer::TCVector<uint8> Contents = fp_ExportContents(lDesktopContents);
		...
		{
			NContainer::TCVector<uint8> Contents = fp_ExportContents(_Desktop);
		...
		NContainer::TCVector<uint8> CDesktopFileParser::fp_ExportContents(NContainer::TCVector<CDesktopGroup> const &_Desktop)
		{
			NContainer::TCVector<uint8> Contents;
